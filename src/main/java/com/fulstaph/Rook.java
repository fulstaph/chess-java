...
public class Rook extends Piece {
    ...
    public boolean isValidMove(Position newPosition, Piece[][] board) {
        ...
        if (destinationPiece == null) {
            ...
            return destinationPiece.getColor() != this.getColor(); // The destination has an opponent's piece, capture is valid.
        // The destination has a piece of the same color, move is invalid
    }
}
